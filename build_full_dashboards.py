...
def create_full_dashboards_xml():
    # Construct complete, professional 4-Dashboard Tableau Workbook
...
<workbook original-version='18.1' source-build='2020.4.0' source-platform='win' version='18.1' xmlns:user='http://www.tableausoftware.com/xml/user'>
  ...
  <worksheets>
    <!-- Dashboard 1 Worksheets -->
    <worksheet name='KPI_Total_Titles'>
      <layout-options><title><formatted-text><run fontcolor='#B3B3B3' fontname='Arial' fontsize='10' bold='true'>TOTAL TITLES</run></formatted-text></title></layout-options>
      <table>
        <view>
    ...
    <worksheet name='KPI_Movies'>
      <layout-options><title><formatted-text><run fontcolor='#B3B3B3' fontname='Arial' fontsize='10' bold='true'>MOVIES (69.6%)</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='KPI_TV_Shows'>
      <layout-options><title><formatted-text><run fontcolor='#B3B3B3' fontname='Arial' fontsize='10' bold='true'>TV SHOWS (30.4%)</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Yearly_Additions_Combo'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Content acquisition peaked in 2019 (2,016 titles) and has disciplined since</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Movie_vs_TV_Donut'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Movies represent 69.6% of total catalogue vs 30.4% TV Shows</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Seasonality_Heatmap'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>July experiences peak content drops while February remains the lowest acquisition month</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Global_Filled_Map'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>United States and India drive global catalogue volume across 120+ production markets</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Top_Countries_Bar'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Top production hubs: US leads with 3,690 titles; India #2 with 1,046 titles</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
        ...
        <panes>
          <pane selection-relaxation-option='selection-relaxation-allow'>
            <view><breakdown value='auto' /></view>
            <mark class='Bar' />
            <encodings><color column='[federated.dim_titles].[none:type:nk]' /></encodings>
          </pane>
        </panes>
    ...
    <worksheet name='Butterfly_US_vs_India'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>India slate is 92% Movies vs US slate having 25.4% TV Shows — Series Opportunity Gap</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Country_Summary_Table'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Market level summary: Title volume, TV share %, Adult audience %, and Avg Content Age</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <!-- Dashboard 3 Worksheets -->
    <worksheet name='Genre_Treemap'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>International Movies (2,752) and Dramas (2,427) constitute the largest content pillars</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Audience_Segment_Stacked_Bar'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Adult content (TV-MA &amp; R) commands 45.5% share; Kids &amp; Family remain under-represented (~23%)</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
        ...
        <panes>
          <pane selection-relaxation-option='selection-relaxation-allow'>
            <view><breakdown value='auto' /></view>
            <mark class='Bar' />
            <encodings><color column='[federated.dim_titles].[none:audience_segment:nk]' /></encodings>
          </pane>
        </panes>
        <rows>[federated.dim_titles].[cd:show_id:qk]</rows>
        <cols>[federated.dim_titles].[none:year_added:ok]</cols>
    ...
    <worksheet name='Top_Directors_Actors'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Top Creative Talent: Rajiv Chilaka (22 dir) and Anupam Kher (43 cast) lead frequent listings</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Movie_Runtime_Histogram'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Movie runtimes cluster around 90-100 minutes with a median duration of 98.0 min</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <!-- Dashboard 4 Worksheets -->
    <worksheet name='Fresh_Content_Area'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>55% of acquisitions are fresh releases (added within 1 year of production)</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Content_Age_Buckets_Bar'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>Day-and-date &amp; 1-year releases form the dominant share of catalogue licensing</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='Season_Count_Distribution_Bar'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>67.0% of TV series cancel/end after Season 1 — High early churn rate</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
    ...
    <worksheet name='TV_Share_Trend_Line'>
      <layout-options><title><formatted-text><run fontcolor='#F5F5F1' fontname='Arial' fontsize='12' bold='true'>TV Series share of additions increased from 25.0% (2018) to 33.7% (2021) — Pivot to Retention</run></formatted-text></title></layout-options>
      <table>
        <view>
          <datasources><datasource caption='dim_titles' name='federated.dim_titles' /></datasources>
          <datasource-dependencies datasource='federated.dim_titles'>
  ...
  <dashboards>
    ...
    <dashboard name='1. Executive Overview'>
      ...
      <zones>
        <zone h='100000' id='1' type-name='layout-basic' w='100000' x='0' y='0'>
          <zone h='6000' id='2' type-name='text' w='96000' x='2000' y='2000'>
            <formatted-text>
          ...
          <zone h='10000' id='3' name='KPI_Total_Titles' w='30000' x='2000' y='9000' />
          <zone h='10000' id='4' name='KPI_Movies' w='30000' x='34000' y='9000' />
          <zone h='10000' id='5' name='KPI_TV_Shows' w='32000' x='66000' y='9000' />
          <zone h='38000' id='6' name='Yearly_Additions_Combo' w='60000' x='2000' y='21000' />
          <zone h='38000' id='7' name='Movie_vs_TV_Donut' w='34000' x='64000' y='21000' />
          <zone h='32000' id='8' name='Seasonality_Heatmap' w='96000' x='2000' y='61000' />
          <zone h='3000' id='9' type-name='text' w='96000' x='2000' y='95000'>
            <formatted-text>
              <run fontcolor='#B3B3B3' fontname='Arial' fontsize='9'>Data Source: Kaggle Netflix Catalogue Snapshot | Author: Deepanshu Garkoti | LinkedIn: linkedin.com/in/deepanshugarkoti | GitHub: github.com/Deepanshu-tech7</run>
            </formatted-text>
          </zone>
        </zone>
      </zones>
    ...
    <dashboard name='2. Global Footprint'>
      ...
      <size maxheight='900' maxwidth='1200' minheight='900' minwidth='1200' sizing-mode='fixed' />
      <zones>
        <zone h='100000' id='20' type-name='layout-basic' w='100000' x='0' y='0'>
          <zone h='6000' id='21' type-name='text' w='96000' x='2000' y='2000'>
            <formatted-text>
              <run fontcolor='#E50914' fontname='Arial Black' fontsize='18' bold='true'>NETFLIX CONTENT INTELLIGENCE</run>
              <run fontcolor='#F5F5F1' fontname='Arial' fontsize='16' bold='true'> | Global Footprint &amp; Slate Analysis</run>
            </formatted-text>
          </zone>
          <zone h='42000' id='22' name='Global_Filled_Map' w='58000' x='2000' y='9000' />
          <zone h='42000' id='23' name='Top_Countries_Bar' w='36000' x='62000' y='9000' />
          <zone h='40000' id='24' name='Butterfly_US_vs_India' w='47000' x='2000' y='53000' />
          <zone h='40000' id='25' name='Country_Summary_Table' w='47000' x='51000' y='53000' />
          <zone h='3000' id='26' type-name='text' w='96000' x='2000' y='95000'>
            <formatted-text>
              <run fontcolor='#B3B3B3' fontname='Arial' fontsize='9'>Data Source: Kaggle Netflix Catalogue Snapshot | Author: Deepanshu Garkoti | LinkedIn: linkedin.com/in/deepanshugarkoti | GitHub: github.com/Deepanshu-tech7</run>
            </formatted-text>
          </zone>
    ...
    <dashboard name='3. Genre &amp; Audience'>
      ...
      <size maxheight='900' maxwidth='1200' minheight='900' minwidth='1200' sizing-mode='fixed' />
      <zones>
        <zone h='100000' id='30' type-name='layout-basic' w='100000' x='0' y='0'>
          <zone h='6000' id='31' type-name='text' w='96000' x='2000' y='2000'>
            <formatted-text>
              <run fontcolor='#E50914' fontname='Arial Black' fontsize='18' bold='true'>NETFLIX CONTENT INTELLIGENCE</run>
              <run fontcolor='#F5F5F1' fontname='Arial' fontsize='16' bold='true'> | Genre Architecture &amp; Audience</run>
            </formatted-text>
          </zone>
          <zone h='42000' id='32' name='Genre_Treemap' w='58000' x='2000' y='9000' />
          <zone h='42000' id='33' name='Audience_Segment_Stacked_Bar' w='36000' x='62000' y='9000' />
          <zone h='40000' id='34' name='Top_Directors_Actors' w='47000' x='2000' y='53000' />
          <zone h='40000' id='35' name='Movie_Runtime_Histogram' w='47000' x='51000' y='53000' />
          <zone h='3000' id='36' type-name='text' w='96000' x='2000' y='95000'>
            <formatted-text>
              <run fontcolor='#B3B3B3' fontname='Arial' fontsize='9'>Data Source: Kaggle Netflix Catalogue Snapshot | Author: Deepanshu Garkoti | LinkedIn: linkedin.com/in/deepanshugarkoti | GitHub: github.com/Deepanshu-tech7</run>
            </formatted-text>
          </zone>
    ...
    <dashboard name='4. Content Freshness &amp; Series Health'>
      ...
      <size maxheight='900' maxwidth='1200' minheight='900' minwidth='1200' sizing-mode='fixed' />
      <zones>
        <zone h='100000' id='40' type-name='layout-basic' w='100000' x='0' y='0'>
          <zone h='6000' id='41' type-name='text' w='96000' x='2000' y='2000'>
            <formatted-text>
              <run fontcolor='#E50914' fontname='Arial Black' fontsize='18' bold='true'>NETFLIX CONTENT INTELLIGENCE</run>
              <run fontcolor='#F5F5F1' fontname='Arial' fontsize='16' bold='true'> | Freshness &amp; Series Health</run>
            </formatted-text>
          </zone>
          <zone h='42000' id='42' name='Fresh_Content_Area' w='47000' x='2000' y='9000' />
          <zone h='42000' id='43' name='Content_Age_Buckets_Bar' w='47000' x='51000' y='9000' />
          <zone h='40000' id='44' name='Season_Count_Distribution_Bar' w='47000' x='2000' y='53000' />
          <zone h='40000' id='45' name='TV_Share_Trend_Line' w='47000' x='51000' y='53000' />
          <zone h='3000' id='46' type-name='text' w='96000' x='2000' y='95000'>
            <formatted-text>
              <run fontcolor='#B3B3B3' fontname='Arial' fontsize='9'>Data Source: Kaggle Netflix Catalogue Snapshot | Author: Deepanshu Garkoti | LinkedIn: linkedin.com/in/deepanshugarkoti | GitHub: github.com/Deepanshu-tech7</run>
            </formatted-text>
          </zone>
  ...
  <windows source-height='30'>
    ...
    <!-- Dashboard Windows (Set active window to 1. Executive Overview) -->
...
def apply_full_dashboards():
    proj_dir = r"C:\Users\Deepanshu\.gemini\antigravity-ide\scratch\netflix_analytics\netflix-analytics"
    twb_path = os.path.join(proj_dir, "Netflix_Content_Intelligence.twb")
    twbx_path = os.path.join(proj_dir, "Netflix_Content_Intelligence.twbx")
    downloads_path = r"C:\Users\Deepanshu\Downloads\Netflix_Content_Intelligence.twbx"

    xml_content = create_full_dashboards_xml()
    ...
    with zipfile.ZipFile(twbx_path, "w", zipfile.ZIP_DEFLATED) as zf:
        zf.write(twb_path, arcname="Netflix_Content_Intelligence.twb")
    ...
    with open(twbx_path, "rb") as sf, open(downloads_path, "wb") as df:
        df.write(sf.read())

    print("All 4 Dashboards compiled with 100,000 scale canvas zones!")

if __name__ == "__main__":
    apply_full_dashboards()
